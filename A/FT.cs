namespace A
{
    ...
    public class FT : Form
    {
        ...
        private CheckBox A;
        [DebuggerBrowsable(DebuggerBrowsableState.Never), CompilerGenerated, AccessedThroughProperty("ToolStripButtonOk")]
        ...
        private void A()
        {
            ...
            this.TxTTitle.Text = "استعلام عن مورد";
            ...
            this.TabControl1.TabIndex = 0x72;
            ...
            ToolStripItem[] toolStripItems = new ToolStripItem[] { this.ToolStripButtonOk, this.ToolStripSeparator3, this.ToolStripButtonClose, this.ToolStripSeparator7 };
            ...
            this.ToolStripButtons.TabIndex = 0x73;
            ...
            this.ToolStripStatus.TabIndex = 0x74;
            ...
            this.CheckBoxAllCenter.TabIndex = 0x75;
            ...
            base.Name = "SuplierQuery";
            this.RightToLeft = RightToLeft.Yes;
            this.RightToLeftLayout = true;
            base.ShowIcon = false;
            base.ShowInTaskbar = false;
            base.StartPosition = FormStartPosition.CenterScreen;
            this.Text = "استعلام عن مورد";
        ...
        private void I(object A, EventArgs R)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        A.D.A.A.F();
                        PT.A = Conversions.ToInteger(this.GV.SelectedRows[0].Cells["SuplierID"].Value.ToString());
                        A.D.A.A.ShowDialog();
                    }
                    else
                    {
                        ...
                        {
                            A.D.A.A.R();
                            A.D.A.A.ComboBoxSuplier.SelectedValue = this.GV.SelectedRows[0].Cells["SuplierID"].Value.ToString();
                            base.Dispose();
                        }
                        if (Application.OpenForms.OfType<KD>().Any<KD>())
                        {
                            A.D.A.A.ComboBoxSuplier.SelectedValue = this.GV.SelectedRows[0].Cells["SuplierID"].Value.ToString();
                            base.Dispose();
                        }
                        if (Application.OpenForms.OfType<UD>().Any<UD>())
                        {
                            A.D.A.A.ComboBoxSuplier.SelectedValue = this.GV.SelectedRows[0].Cells["SuplierID"].Value.ToString();
                            base.Dispose();
                        }
                        if (Application.OpenForms.OfType<SD>().Any<SD>())
                        {
                            SD.A = Conversions.ToInteger(this.GV.SelectedRows[0].Cells["SuplierID"].Value.ToString());
                            SD.A = this.GV.SelectedRows[0].Cells["SuplierName"].Value.ToString();
                            A.D.A.A.TimerXSS.Enabled = true;
                            base.Dispose();
                        }
                    }
                    FT.A = false;
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        decimal num = new decimal(Conversion.Val(current.Cells["SuplierBalance"].Value.ToString()));
                        ...
                        current.Cells["SuplierBalance"].Value = num.ToString(PR.YR);
                    }
                }
                finally
                {
